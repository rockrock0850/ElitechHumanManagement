...
public class PermissionRole  implements java.io.Serializable {
    ...
    public PermissionRole(PermissionRoleId id, String createUser, Date createTime) {
        this.id = id;
        this.createUser = createUser;
        this.createTime = createTime;
    }
    public PermissionRole(PermissionRoleId id, String createUser, Date createTime, String modifyUser, Date modifyTime) {
       this.id = id;
       this.createUser = createUser;
       this.createTime = createTime;
