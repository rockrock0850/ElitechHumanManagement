...
<script type="text/javascript" src="${contextPath}/pages/js/function/auth/group_account/add_1.js?v=${now}"></script>

<form id='addGroupAccountForm' class="form-center">
	<div class="card mb-3">
		<div class="card-header">
			<i class="fa fa-search"></i>群組帳號新增
		</div>
