...
<script type="text/javascript" src="${contextPath}/pages/js/function/leave/apply_leave/add_1.js?v=${now}"></script>

<form id='addApplyLeaveForm' class="form-center">
	<input class='hidden' name='departmentId' />

	<div class="card mb-3">
		<div class="card-header">
			<i class="fa fa-search"></i>請假申請單
		</div>
					...
					<div class="form-group">
						<div class='row'>
							...
							<div class='col-7'>
								...
								<input class='hidden' name='departmentName' />
							</div>
						</div>
					</div>
					<div class="form-group">
						<div class='row'>
							...
							<div class='col-4'>
								<div class="form-group">
									<select class='form-control' name='leavetypeId'></select>
								</div>
							</div>
							<div class='col-4'>
								<a>剩餘</a><a id='leftHours' class='color_red'></a><a>小時</a>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="form-group">
						<div class='row'>
							...
							<div class='col-7'>
								...
								<input class='hidden' name='empCname' />
							</div>
						</div>
					</div>
					<div class="form-group">
						<div class='row'>
							...
							<div class='col-7'>
								...
								<input class='hidden' name='jobtitleName' />
							</div>
						</div>
					</div>
				...
				<div class='row full_width_align'>
					<div class='col-md-12'>
						<div class="form-group">
						    <div class="row">
						        <div class="col-md-4">
					                <label class='form_label'>附件上傳</label>
						        </div>
	...
	<input class='hidden' name='process' value='new' />
	<input class='hidden' name='approveStatus' value='approve' />
</form>
