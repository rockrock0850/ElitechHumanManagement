...
<script type="text/javascript" src="${contextPath}/pages/js/function/human/emp_management/add_1.js?v=${now}"></script>

<form id='addEmpManagementForm' class="form-center">
	<div class="card mb-3">
		<div class="card-header">
			<i class="fa fa-search"></i>員工基本資料新增
		</div>
