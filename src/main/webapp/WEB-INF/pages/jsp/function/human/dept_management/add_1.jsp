...
<script type="text/javascript" src="${contextPath}/pages/js/function/human/dept_management/add_1.js?v=${now}"></script>

<form id='addDeptManagementForm' class="form-center">
	<div class="card mb-3">
