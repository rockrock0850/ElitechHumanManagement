...
<script type="text/javascript" src="${contextPath}/pages/js/function/setting/holiday_category/edit_1.js?v=${now}"></script>

<form id='editHolidayCategoryForm' class="form-center">
	<div class="card mb-3">
		<div class="card-header">
			<i class="fa fa-search"></i>假別資料修改
		</div>
				...
				<div class='col-md-6'>
					<div class='form-group'>
						<div class='row'>
							...
							<div class='col-7'>
								<label id='leavetypeId'></label>
								<input class="hidden" type="text" name='leavetypeId' />
							</div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class='row'>
							...
							<div class='col-md-5'>
								<div class="form-group">
									...
									<input class='hidden' name='oldEmptype' />
								</div>
							</div>
						</div>
					</div>
