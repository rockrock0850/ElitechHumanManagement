...
<script type="text/javascript" src="${contextPath}/pages/js/function/setting/holiday_emp/add_1.js?v=${now}"></script>

<div class="card mb-3">
	<div class="card-header">
		<i class="fa fa-search"></i>員工假別可休天數新增
	</div>
	<div class="card-body overflow_x">
		<form id='addHolidayEmpHeaderForm' class="form-center">
			<div class='row'>
				<div class='col-md-6'>
		...
		<form id='addHolidayEmpContentForm' style='overflow-x: auto'></form>
	</div>
</div>